...
(function($) {
  ...
  $.extend($.facebox, {
    settings: {
      ...
      closeImage   : sp_url + '/static/js/facebox/closelabel.gif',
  ...
  function init(settings) {
    ...
    $('#facebox .close').live('click', function(){$.facebox.close();});
  ...
  function fillFaceboxFromIFrame(href, klass) {
    $.facebox.reveal('<iframe id="facebox_iframe" scrolling="auto" frameBorder="0" border="0" src=""></iframe>', klass);
